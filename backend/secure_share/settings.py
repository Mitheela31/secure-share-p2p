"""
Django settings for secure_share.
Foundation configuration using SQLite for development.
"""
...
ASGI_APPLICATION = 'secure_share.asgi.application'

# Database - SQLite (Real persistent data, no mocks)
DATABASES = {
    'default': {
